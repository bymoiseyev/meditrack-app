            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="bg-slate-50 rounded-lg p-3 grid grid-cols-2 gap-3 mb-3">
                  <div>
                    <div className="text-xs font-semibold text-slate-400 uppercase tracking-wide mb-0.5">ATC-kod</div>
                  ...
                  <div>
                    ...
                    <div className="text-sm font-semibold text-slate-700">{med.threshold} enheter</div>
                  </div>
                </div>

                {/* Stock balance */}
                <div>
                  <div className="text-xs font-semibold text-slate-400 uppercase tracking-wide mb-0.5">Lagersaldo</div>
